...
The main objective was to clean and transform a raw e-commerce dataset into a structured and analysis-ready dataset, then explore the data to identify patterns, distributions, relationships, and potential outliers.
...
The average transaction was approximately 1,053.97, 
Median was 823.615.
...
The analysis identified 8 potential outliers. Several of these transactions had quantities of 5 and total prices above 3,300.
...
The analysis showed sales across products.
...
- The median transaction value was 823.615.
- Transaction values ranged from 11.39 to 3,456.40.
- 8 potential outliers were identified.
- Product sales were relatively distributed across the seven products analysed.
- Chair recorded the highest total revenue.
- The highest revenue month was June 2024, with 68,068.54
